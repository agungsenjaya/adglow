        ...
        <div class="mb-5">
            <div class="row">
                ...
                <a href="{{ $data->trailer }}" class="btn btn-dark" target="_blank">
                    <i class="bi-play-fill me-2"></i>Watch Video
                </a>
                @endif
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-3 border-start ps-4">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5 class="fw-bold text-black">Brands / Client</h5>
                                @if($data->artist)
                                {{ $data->artist }}
                                @else
                                -
...
<section class="space-m">
    <div class="container">
    <h4 class="mb-3 text-black fw-bold">More Tv Commercials</h4>
    <div class="swiper swiper-2">
        <div class="swiper-wrapper">
            @foreach($commercial->reverse() as $doc)
            <div class="swiper-slide">
