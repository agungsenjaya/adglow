                  ...
                  <td>
                      <div class="dropdown ">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          <li><a class="dropdown-item" href="javascript:void(0)" data-fancybox="book" data-src="{{ $musi->img }}" data-caption="{{ $musi->title }}">Image</a></li>
                          @if($musi->trailer)
                          ...
                          @endif
                          <li><a class="dropdown-item" href="{{ route('admin.book_edit', ['id' => $musi -> id]) }}">Edit</a></li>
                        </ul>
                      </div>
                  </td>
                </tr>
